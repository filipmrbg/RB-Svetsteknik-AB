...
const LOGO_ABSOLUTE_URL = 'https://raw.githubusercontent.com/filipmrbg/RB-Svetsteknik-AB/main/public/og-image.png';
...
export function usePageTitle(title: string, description?: string) {
  ...
  useEffect(() => {
    ...
    const defaultDesc = "RB Svetsteknik AB utför professionell svetsning, stålmontage, industriservice, fältservice och byggsmide i Byske, Skellefteå och hela Västerbotten. Kontakta oss för fri offert!";
