        ...
        >
          ...
          <div style={{ maxWidth: '440px' }}>
            <ScrollReveal animation="fade-left" delay={100}>
              ...
              >
                Här kan du se exempel på våra utförda svetsarbeten, stålmontage och industriservice i Byske, Skellefteå och norra Sverige. Hovra över bandet för att pausa eller klicka på en bild för att förstora.
              </p>
            </ScrollReveal>
          </div>
        </div>
